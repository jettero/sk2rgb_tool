...
pub enum Key {
    ...
    // Number row
    Grave, N1, N2, N3, N4, N5, N6, N7, N8, N9, N0, Minus, Equals, Bksp,
    ...
    // Bottom row
    LCtrl, LWin, LAlt, Space, RAlt, RWin, Menu, RCtrl, Fn,
...
impl Key {
    pub fn name(self) -> &'static str {
        ...
        match self {
            ...
            Minus => "minus", Equals => "equals", Bksp => "bksp",
            ...
            J => "j", K => "k", L => "l",
            Semicolon => "semicolon", Apostrophe => "apostrophe", Enter => "enter",
            ...
            LCtrl => "lctrl", LWin => "lwin", LAlt => "lalt",
            Space => "space",
            RAlt => "ralt", RWin => "rwin", Menu => "menu", RCtrl => "rctrl",
            Fn => "fn",
            ...
            NumLock => "numlock", KpDiv => "kpdiv", KpMul => "kpmul", KpSub => "kpsub",
            Kp7 => "kp7", Kp8 => "kp8", Kp9 => "kp9", KpAdd => "kpadd",
            Kp4 => "kp4", Kp5 => "kp5", Kp6 => "kp6",
            Kp1 => "kp1", Kp2 => "kp2", Kp3 => "kp3", KpEnter => "kpenter",
            Kp0 => "kp0", KpDot => "kpdot",
        }
    }
    ...
    pub fn xt_scancode(self) -> Option<u16> {
        ...
        Some(match self {
            ...
            Minus => 0x0c, Equals => 0x0d, Bksp => 0x0e,
            Tab => 0x0f,
            ...
            KpMul => 0x37, LAlt => 0x38, Space => 0x39, Caps => 0x3a,
            F1 => 0x3b, F2 => 0x3c, F3 => 0x3d, F4 => 0x3e, F5 => 0x3f,
            F6 => 0x40, F7 => 0x41, F8 => 0x42, F9 => 0x43, F10 => 0x44,
            NumLock => 0x45, ScrLk => 0x46,
            Kp7 => 0x47, Kp8 => 0x48, Kp9 => 0x49, KpSub => 0x4a,
            Kp4 => 0x4b, Kp5 => 0x4c, Kp6 => 0x4d, KpAdd => 0x4e,
            Kp1 => 0x4f, Kp2 => 0x50, Kp3 => 0x51, Kp0 => 0x52,
            KpDot => 0x53,
            F11 => 0x57, F12 => 0x58,
            // E0-prefixed extended scancodes stored as 0x80+code in the table:
            KpDiv => 0xb5, KpEnter => 0x9c,
            RCtrl => 0x9d, RAlt => 0xb8,
            Home => 0xc7, Up => 0xc8, PgUp => 0xc9,
            Left => 0xcb, Right => 0xcd,
            End => 0xcf, Down => 0xd0, PgDn => 0xd1,
            Ins => 0xd2, Del => 0xd3,
            LWin => 0xdb, RWin => 0xdc, Menu => 0xdd,
            PrtSc => 0xb7, Pause => 0xc5,
...
pub const ALL_KEYS: &[Key] = &[
    ...
    Key::RShift,
    Key::LCtrl, Key::LWin, Key::LAlt,
    Key::Space,
    Key::RAlt, Key::RWin, Key::Menu, Key::RCtrl, Key::Fn,
    Key::Ins, Key::Home, Key::PgUp,
    Key::Del, Key::End, Key::PgDn,
    Key::Up, Key::Down, Key::Left, Key::Right,
    Key::NumLock, Key::KpDiv, Key::KpMul, Key::KpSub,
    Key::Kp7, Key::Kp8, Key::Kp9, Key::KpAdd,
    Key::Kp4, Key::Kp5, Key::Kp6,
    Key::Kp1, Key::Kp2, Key::Kp3, Key::KpEnter,
    Key::Kp0, Key::KpDot,
];
...
mod tests {
    ...
    fn letter_run_expands() {
        assert_eq!(resolve_bare("wasd"), Some(vec![Key::W, Key::A, Key::S, Key::D]));
        assert_eq!(resolve_bare("paul"), Some(vec![Key::P, Key::A, Key::U, Key::L]));
    }
